...
# the target file is "gnometext_theme_template.xml"
# you can find this template in https://github.com/fm3chanic/gnome_text_editor_themes
...
f = open('gnometext_theme_template.xml', 'r', encoding='utf-8')
content = f.read()
f.close()
